...
export const OptimizedLazyImage = React.memo(
  ({
    ...
    const generateSources = (baseSrc: string) => {
      ...
      // JPG / PNG — serve WebP variants with original as fallback
      ...
      <div ref={imgRef} className={cn("relative overflow-hidden", className)}>
        ...
        {(isIntersecting || priority) && !hasError && sources && (
          <picture>
            ...
            />
            {/* Fallback to original format with responsive sizes (only for non-webp sources) */}
            {sources.original && (
              <source
